...
6. When you're connected with the user of your choice, create the database: `CREATE DATABASE broffee;`
7. In your Broffee-Back root folder, duplicate `.env.exemple`, rename it to `.env`, and add the right values to the right keys ! (especially `DATABASE_USERNAME` & `DATABASE_PASSWORD`)
5. That's it, now you're ready to share coffees with your friends ! ☕❤️   
